# --------------------------------------------------------------------------------------------
# Modified by Haiyang Xu for 2023SP Deep Learning Lab in USTC
# Add some hyperparameter variables according to Lab requirements and modify the code to support hyperparameter tuning
...
def get_args_parser():
    ...
    parser.add_argument('--normalization', type=str2bool, default=True,
                        help='use normalization in model')
    ...
    parser.add_argument('--data_set', default='IMNET', choices=['CIFAR', 'IMNET', 'image_folder', 'TINY_IMNET'],

...
class BERT(nn.Module):
    def __init__(self):
        super().__init__()
        self.model = BertModel.from_pretrained("./results/bert-base-uncased-util25/checkpoint-6000/")
...
if __name__ == "__main__":
    ...
    bert_pretrain_path = "./results/bert-base-uncased-util25/checkpoint-6000/pytorch_model.bin"
    ...
    training_args = TrainingArguments(
        logging_steps=20,
        output_dir="./results/test-bert-base-uncased-util25",
        num_train_epochs=5,
